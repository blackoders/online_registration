defmodule CustomerTest do
  ...
  test "valid customer", state do
    assert Customer.is_valid(state[:valid_customer])
  end

  test "invalid customer", state do
    refute Customer.is_valid(state[:invalid_customer])
  end
  ...
  test "invalid by name", state do
    ...
    refute Customer.is_valid(invalid_customer_by_name)
    ...
    test "invalid by aadhar", state do
      ...
      refute Customer.is_valid(invalid_customer_by_aadhar)
